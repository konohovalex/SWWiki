...
android {
    namespace = "ru.konohovalex.swwiki.feature.vehicle.details.presentation.impl"
}
...
dependencies(
    ...
    Api(projects.feature.vehicle.details.domain.api),
    Api(projects.feature.vehicle.details.presentation.api),
)
